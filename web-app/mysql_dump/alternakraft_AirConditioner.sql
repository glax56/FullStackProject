...
CREATE TABLE `AirConditioner` (
  ...
  CONSTRAINT `fk_AirConditioner_house_app_ID_AirHandler_householdID` FOREIGN KEY (`householdID`, `applianceID`) REFERENCES `AirHandler` (`householdID`, `applianceID`) ON DELETE CASCADE
...
INSERT INTO `AirConditioner` VALUES (1,1,12),(2,1,14.5),(16,1,23);
