...
CREATE TABLE `HeatPump` (
  ...
  CONSTRAINT `fk_HeatPump_house_app_ID_AirHandler_householdID` FOREIGN KEY (`householdID`, `applianceID`) REFERENCES `AirHandler` (`householdID`, `applianceID`) ON DELETE CASCADE
...
INSERT INTO `HeatPump` VALUES (5,1,16.5,9),(10,1,17.8,9.4);
