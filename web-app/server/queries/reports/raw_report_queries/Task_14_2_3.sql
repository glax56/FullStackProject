...
-- Note: For these averages below, SQL AVG ignores null values (so will ignore households w/o heating/cooling)
-- Average heating temperature (as a decimal number rounded to tenths)
